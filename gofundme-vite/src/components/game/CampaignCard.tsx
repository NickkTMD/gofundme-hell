...
export default function CampaignCard({
  ...
  return (
    <div
      className={`relative w-full h-full md:max-w-xl md:max-h-[800px] md:bg-slate-800 md:rounded-3xl overflow-hidden md:shadow-2xl flex flex-col md:border-4 md:border-white/20 ${animationClass}`}
    >
      ...
      <div className="absolute inset-0 md:relative md:flex-1 md:min-h-0 bg-black">
        ...
        />
        {/* Gradient fade to black on mobile, to slate on desktop */}
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 via-30% to-transparent md:from-slate-900 md:via-transparent" />
      ...
      <div className="relative mt-auto p-4 md:p-6 md:bg-gradient-to-t md:from-slate-900 md:to-slate-900/95">
